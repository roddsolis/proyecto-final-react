    ...
    <>
      ...
      <div className="sessionWrapper">
        ...
        <div className="tutorContent">
          ...
          {estadoTutor.tutor_en_sala ? <CustomSwitch estadoTutor={estadoTutor} handleChangeEstado={() => {}} /> : <CustomSwitch estadoTutor={estadoTutor} handleChangeEstado={handleChangeEstado} />}
        </div>
        ...
        <div className="emptyState">
          ...
          {estadoTutor?.estado === true && estadoTutor?.solicitud_entrante === false && estadoTutor?.tutor_en_sala === false && solicitudTutor?.estado === null && solicitudTutor?.confirmacion_tutor === null && (
            <>
              <div className="sinSolicitudes">Aún no tienes solicitudes. Buscando...</div>
            </>
          )}
          ...
          {estadoTutor?.estado === true && estadoTutor?.solicitud_entrante === true && estadoTutor?.tutor_en_sala === false && solicitudTutor?.estado === null && solicitudTutor?.confirmacion_tutor === null && (
            <>
              <div className="mb-0">
                <strong>{String(solicitudTutor.alumno_nombre)}</strong> está esperando un tutor{" "}
              </div>

              <div className="emptyStateButtons">
                <button onClick={() => handleRechazarSolicitud(tutorId)} className="btn-m btn-secondary">
                  Cancelar
                </button>
                <button onClick={() => handleAceptarSolicitud(tutorId)} className="btn-m btn-primary">
                  Aceptar
                </button>
              </div>
            </>
          ...
          {estadoTutor?.estado === false && estadoTutor?.solicitud_entrante === false && estadoTutor?.tutor_en_sala === true && solicitudTutor?.estado === true && solicitudTutor?.confirmacion_tutor === true && (
            <>
              <div className="paragraph-m">Aceptaste la solicitud con {String(solicitudTutor.alumno_nombre)}</div>
          ...
          {estadoTutor?.estado === false && estadoTutor?.solicitud_entrante === false && estadoTutor?.tutor_en_sala === false && solicitudTutor?.estado === false && solicitudTutor?.confirmacion_tutor === false && (
            <>
              <div className="paragraph-m">Rechazaste la solicitud, ¿intentar buscar nuevamente?</div>
              <div>
                <button onClick={handleChangeEstado} className="btn-m btn-primary">
                  Seguir buscando
                </button>
              </div>
            </>
          ...
          {estadoTutor?.estado === false && estadoTutor?.solicitud_entrante === false && estadoTutor?.tutor_en_sala === true && solicitudTutor?.estado === null && solicitudTutor?.confirmacion_tutor === true && (
            <>
              <div className="paragraph-m">Aceptaste la solicitud con {String(solicitudTutor.alumno_nombre)}, ir a la sala</div>
              <button className="btn-m btn-primary">Ir a la sala</button>
            </>
          )}
          ...
          {estadoTutor?.estado === true && estadoTutor?.solicitud_entrante === false && estadoTutor?.tutor_en_sala === false && solicitudTutor?.estado === false && solicitudTutor?.confirmacion_tutor === null && (
            <>
              <p className="paragraph-m">El alumno tuvo que cancelar la solicitud. Seguimos buscando...</p>
            </>
          )}
        </div>
      </div>
