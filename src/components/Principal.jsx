        ...
        <>
          ...
          <div className='mainContent'>
            ...
            <p className='paragraph-m'>
              Debes seleccionar una categoria y luego una sub-categoria para buscar
              un tutor en linea y haremos match con el tutor que mejor se adapte a
              tu necesidad
            </p>
          </div>
          <Categorias />
          ...
          <div className='sessionWrapper'>
            <h3 className='subtitle-sm'>
              Ultima Sesion
            </h3>
            <p className='paragraph-m'>
              Si deseas acceder a la informacion proporcionada por el tutor puedes
              ingresar nuevamente a la sala
            </p>
          </div>
