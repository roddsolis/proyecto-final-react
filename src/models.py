...
class Alumno(db.Model):
    ...
    datos_de_pago = db.relationship(
        'Metodo_de_pago', backref='alumno', uselist=False)
    materia_seleccionada = db.relationship(
        'Category', backref='alumno', uselist=False)
...
class Tutor(db.Model):
    ...
    datos_bancarios = db.relationship(
        'Cuenta_bancaria', backref='tutor', uselist=False)
    materia_seleccionada = db.relationship(
        'Category', backref='tutor', uselist=False)
...
class Perfil(db.Model):
    ...
    alumno_id = db.Column(db.Integer, db.ForeignKey(
        'alumnos.id'), nullable=False)
    tutor_id = db.Column(db.Integer, db.ForeignKey(
        'tutores.id'), nullable=False)
...
class Sala(db.Model):
    __tablename__ = 'salas'
    id = db.Column(db.Integer, primary_key=True)
    solicitud_sala_id = db.Column(db.Integer, db.ForeignKey(
        'solicitud_sala.id'), nullable=False, unique=True)
    alumno_id = db.Column(db.Integer, db.ForeignKey(
        'alumnos.id'), nullable=False)
    tutor_id = db.Column(db.Integer, db.ForeignKey(
        'tutores.id'), nullable=False)
